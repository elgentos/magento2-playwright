...
test.describe(
	'Minicart Actions',
	{ annotation: { type: 'Minicart', description: 'Minicart simple product tests' } },
	() => {
		/**
		...
		test.beforeEach(async ({ page }) => {
			...
			await expect(
				page.getByText(outcomeMarker.miniCart.simpleProductInCartTitle),
			).toBeVisible();
		});
...
test.describe(
	'Minicart Actions',
	{ annotation: { type: 'Minicart', description: 'Minicart configurable product tests' } },
	() => {
		/**
		 * @feature BeforeEach runs before each test in this group.
		...
		test.beforeEach(async ({ page }) => {
			...
			await mainMenu.openMiniCart();
			await expect(
				page.getByText(outcomeMarker.miniCart.configurableProductMinicartTitle),
			).toBeVisible();
		});
