...
/**
 * NOTE:
 * This first if-statement checks if the setup variable has been set to true.
 * If so, the testing suite ONLY runs the setup test.
 * Below (starting at line 132), we check if the testing suite is bein run in CI.
 * If so, we run the setup tests. 
 */
