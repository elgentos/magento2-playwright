 ...
 */
productTest('Address_is_filled_in_at_checkout_for_user', {tag: ['@checkout', '@user']}, async ({userProductPage}) => {
 ...
 */
productTest('User_place_order_for_simple_product', {tag: ['@checkout', '@user']}, async ({userProductPage, page}, testInfo) => {
